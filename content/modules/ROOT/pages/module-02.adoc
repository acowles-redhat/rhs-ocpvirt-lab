...
+
image::module-02/02-Fedora01-PVC-Details.png[link=self, window=blank, width=100%]
...
+
image::module-02/05_Snapshots_Menu.png[link=self, window=blank, width=100%]
...
+
image::module-02/11_VM_Snapshot_Dialog.png[link=self, window=blank, width=100%]

. Press *Save* and wait till the _Snapshot_ has been created and the *status* shows as `Succeeded`
+
image::module-02/12_VM_Snapshot_Taken.png[link=self, window=blank, width=100%]

. Press the three dots and check that the *Restore* option is greyed out because the VM is running
+
image::module-02/13_VM_Restore_Disabled.png[link=self, window=blank, width=100%]
...
+
image::module-02/14_VM_Crashed.png[link=self, window=blank, width=100%]
...
+
image::module-02/15_VM_Restore.png[link=self, window=blank, width=100%]

. In the dialog shown, press *Restore*
+
image::module-02/16_VM_Restore_Dialog.png[link=self, window=blank, width=100%]

. Wait until the VM is restored, and then start the VM 
+
image::module-02/17_VM_Restored.png[link=self, window=blank, width=100%]

. Verify that the VM is booting correctly again.
+
image::module-02/18_VM_Running.png[link=self, window=blank, width=100%]
...
+
image::module-02/19_VM_Clone_Dialog.png[link=self, window=blank, width=100%]
+
[NOTE]
...
+
image::module-02/20_VM_Cloned.png[link=self, window=blank, width=100%]
+
[IMPORTANT]
