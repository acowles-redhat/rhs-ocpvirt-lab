...
+
image::module-04/07_Catalog_Create_VM_Overview.png[]
+
...
+
image::module-04/09_Template_Catalog.png[]
+
. Scroll down until you find the *Microsoft Windows Server 2019 VM* tile.
image::module-04/10_Windows_2k19_Tile.png[]
...
+
image::module-04/11_Windows_2k19_Dialog.png[]
+
. In this dialog:
...
+
image::module-04/12_Windows_2k19_Parameters.png[]
+
...
+
image::module-04/15_Windows_2k19_Sysprep.png[]
+
