...
+
. Once the VM installation process is complete, we can take a snapshot of the rootdisk, and use that to create a bootable volume template that we can use to boot other Windows 2k19 machines.
+
...
+
. Once this is saved, you can return to the *Virtualization -> Catalog* menu, and use this cloned PVC as a future boot source for creating new Virtual Machines by selecting the *PVC (clone PVC)* as the *Disk source* and selecting the *Windows-2k19-Template* PVC as the *PVC name* to clone.
+
