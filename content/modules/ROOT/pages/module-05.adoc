...
+
image::module-05/00_vSphere_VM_List.png[]
+
////
[NOTE]
...
+
image::module-05/01_vSphere_Network.png[]
...
+
image::module-05/02_vSphere_Datastore.png[]
...
+
image::module-05/03_MTV_Providers.png[]
+
[TIP]
...
+
image::module-05/04_MTV_Provider_list.png[]
...
+
image::module-05/05_MTV_Create_Provider.png[]
+
// WKTBD: replace with student's credentials
...
+
image::module-05/06_MTV_Fill_Dialog.png[]
.  Press *Create* and wait till the *Status* column is changed to `Ready`
+
image::module-05/07_MTV_Provider_Added.png[]
...
+
image::module-05/08_MTV_NetworkMaps.png[]
...
+
image::module-05/12_Add_VMWARE_Mapping_Storage.png[]

. Ensure the created mapping has the *Status* `Ready`
+
image::module-05/13_List_VMWARE_Mapping_Storage.png[]
...
+
image::module-05/14_Create_VMWARE_Plan.png[]
