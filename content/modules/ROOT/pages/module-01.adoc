...
+
image::module-01/Compute_Nodes.png[]
+
...
+
image::module-01/Worker0_Information.png[]
+
...
+
image::module-01/Worker0_Details.png[]
...
+
image::module-01/Worker0_BMhost.png[]
+
...
+
image::module-01/add_host_red.png[]
+
...
+
image::module-01/create_host_red.png[]
+
...
+
image::module-01/worker4_summary_1.png[]
+
[NOTE]
...
+
image::module-01/worker4_summary_2.png[]
+
