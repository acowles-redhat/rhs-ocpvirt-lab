...
+
image::images/Create_VM_URL/01_Template_List.png[]

. Press *Create Template* and review auto filled YAML code
+
image::images/Create_VM_URL/02_Template_YAML.png[]
+
[NOTE]
...
+
image::images/Create_VM_URL/08_Ephemeral_Disk.png[]
...
+
image::images/Create_VM_PVC/15_Windows_2k9_Parameters_Filled.png[]

. Switch to the *Scripts* tab and press *Edit* on the `Sysprep` section
+
image::images/Create_VM_PVC/16_Windows_2k9_Scripts.png[]
...
+
image::images/Create_VM_PVC/17_Windows_2k9_Sysprep.png[]

. Press *Create VirtualMachine*
+
image::images/Create_VM_PVC/18_Windows_2k9_Create.png[]
...
+
image::images/Create_VM_PVC/19_Windows_2k9_Provisioning.png[]

. After a few minutes, the Virtual VM will be in `Running` status. Switch to the *Console* tab:
+
image::images/Create_VM_PVC/20_Windows_2k9_Console.png[]
+
[NOTE]
