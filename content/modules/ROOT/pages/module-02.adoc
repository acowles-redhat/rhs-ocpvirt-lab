...
Working with storage in OpenShift Virtualization can be a different experience than working with other hypervisors. Understanding of the following terms may be helpful for this section of the lab:
...
[[default_boot]]
== Exploring Default Boot Sources
...
+
image::module-02/00_Left_Menu.png[]
...
+
image::module-02/03_PVC_Info.png[]
...
+
image::module-02/04_List_PVCs_VMs.png[]

. Select the `fedora02` to obtain information
+
image::module-02/05_PVC_VM_Info.png[]
...
+
image::module-02/09_VM_Overview.png[]

. Navigate to the *Snapshots* tab
+
image::module-02/10_VM_Snapshots_Tab.png[]
