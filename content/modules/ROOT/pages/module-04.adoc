...
+
. A new window will pop out where you can edit the amount of CPU and Memory. For our XL template set the value of CPUs to 8, and Memory to 16 GiB, and click the *Save* button.
+
