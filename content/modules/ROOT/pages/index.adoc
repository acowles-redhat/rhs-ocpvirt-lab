...
* Remote access console uses US keyboard layout, so it's good to know where special characters reside for other country layouts. Or use copy paste with recommended browser.
