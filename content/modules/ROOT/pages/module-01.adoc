...
IMPORTANT: Ensure that you are in the *openshift-machine-api* project before you begin these steps or machine discovery will not work. You may need to toggle the *Show default projects* switch to see that project.
...
+
NOTE: This step can take significant time, as the node reboots several times during the installation process. Do not wait for it to finish, just check back at the end of the lab.
+
