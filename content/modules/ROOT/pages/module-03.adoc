...
For this section of the lab we are going to create a *MultiNetwork Policy* that prevents all traffic by default from any other namespace from reaching our VM.

// Pick up here - MultiNetwork Policy syntax issue, regular network policy ingress issue, also confirm NAD failures through GUI
